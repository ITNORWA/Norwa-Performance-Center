frappe.pages['strategy-map'].on_page_load = function (wrapper) {
...
function load_root_nodes(page) {
    ...
    frappe.call({
        method: "performance_scorecard.performance_scorecard.page.strategy_map.strategy_map.get_root_nodes",
        callback: function (r) {
            if (r.message) {
...
function load_children(nodeType, nodeId, parentContext) {
    ...
    frappe.call({
        method: "performance_scorecard.performance_scorecard.page.strategy_map.strategy_map.get_children",
        args: {
            node_type: nodeType,
            node_id: nodeId,
            context: context
